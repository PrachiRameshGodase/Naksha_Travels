...
import { rackDetailAction, zoneDetailAction } from '../../../Redux/Actions/warehouseActions';
...
const RacksDetail = () => {
    ...
    useEffect(() => {
        if (itemId) {
            ...
            dispatch(rackDetailAction(queryParams));
        }
    }, [dispatch, itemId]);
    ...
    const handleEditThing = (val) => {
        ...
        if (val === "move") {
            ...
            Navigate(`/dashboard/create-racks?${queryParams.toString()}`);
        }
