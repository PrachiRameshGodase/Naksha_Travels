...
import { binDetailAction, rackDetailAction, zoneDetailAction } from '../../../Redux/Actions/warehouseActions';
import { InsideBinBox, InsideRacksBox } from '../../Items/InsideItemDetailsBox';
...
const BinsDetail = () => {
    ...
    const item_detail = useSelector(state => state?.binDetail);
    ...
    useEffect(() => {
        if (itemId) {
            ...
            dispatch(binDetailAction(queryParams));
        }
    }, [dispatch, itemId]);
    ...
    const handleEditThing = (val) => {
        ...
        if (val === "move") {
            ...
            Navigate(`/dashboard/create-bins?${queryParams.toString()}`);
        }
            ...
            <Toaster />
            {
                item_detail?.loading ? <Loader02 /> :
                    ...
                    <>
                        ...
                        <div id="item-details">
                            <InsideBinBox itemDetails={item_details} />
                        </div >
