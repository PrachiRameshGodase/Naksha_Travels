...
import sortbyIcon from '../../../assets/outlineIcons/othericons/sortbyIco.svg';
...
const Zone = () => {
    ...
    useEffect(() => {
        fetchQuotations();
    }, [currentPage, itemsPerPage, searchCall, warehouseId, allFilters]);
            ...
            <div id="middlesection" >
                <div id="Anotherbox">
                    ...
                    <div id="buttonsdata">
                        ...
                        <Link className="linkx1" to={"/dashboard/create-zone"} data-tooltip-place="bottom" data-tooltip-content="New Bill" data-tooltip-id="my-tooltip">
                            New Zone <GoPlus />
                        </Link>
