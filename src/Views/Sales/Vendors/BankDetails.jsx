                    ...
                    <div className="form_commonblock">
                      ...
                      <div id="inputx1">
                        <span>
                          ...
                          <input type="text" autoComplete='off' value={person.ifsc_code} onChange={(e) => handleChange("ifsc_code", index, e.target.value)} placeholder="Enter IFSC Code" name="ifsc_code" />
                        </span>
                      </div>
                      {ifsc_codeError && <p className="error-message">
                        {otherIcons.error_svg}
                        Please enter IFSC code.</p>}
                    </div>
